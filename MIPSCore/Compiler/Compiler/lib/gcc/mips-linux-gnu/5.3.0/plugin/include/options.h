...
enum opt_code
{
  ...
  OPT_mglibc = 1186,                         /* -mglibc */
  OPT_mgp32 = 1187,                          /* -mgp32 */
  OPT_mgp64 = 1188,                          /* -mgp64 */
  OPT_mgpopt = 1189,                         /* -mgpopt */
  OPT_mhard_float = 1190,                    /* -mhard-float */
  OPT_mimadd = 1191,                         /* -mimadd */
  OPT_minterlink_compressed = 1192,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1193,              /* -minterlink-mips16 */
  OPT_mips = 1194,                           /* -mips */
  OPT_mips16 = 1195,                         /* -mips16 */
  OPT_mips16e = 1196,                        /* -mips16e */
  OPT_mips3d = 1197,                         /* -mips3d */
  OPT_mllsc = 1198,                          /* -mllsc */
  OPT_mlocal_sdata = 1199,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1200,                    /* -mlong-calls */
  OPT_mlong32 = 1201,                        /* -mlong32 */
  OPT_mlong64 = 1202,                        /* -mlong64 */
  OPT_mlra = 1203,                           /* -mlra */
  OPT_mmad = 1204,                           /* -mmad */
  OPT_mmcount_ra_address = 1205,             /* -mmcount-ra-address */
  OPT_mmcu = 1206,                           /* -mmcu */
  OPT_mmemcpy = 1207,                        /* -mmemcpy */
  OPT_mmicromips = 1208,                     /* -mmicromips */
  OPT_mmt = 1209,                            /* -mmt */
  OPT_mnan_ = 1210,                          /* -mnan= */
  OPT_mno_float = 1211,                      /* -mno-float */
  OPT_mno_flush_func = 1212,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1213,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1214,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1215,                     /* -mno-mips3d */
  OPT_modd_spreg = 1216,                     /* -modd-spreg */
  OPT_mpaired_single = 1217,                 /* -mpaired-single */
  OPT_mplt = 1218,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1219,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1220,               /* -mrelax-pic-calls */
  OPT_mshared = 1221,                        /* -mshared */
  OPT_msingle_float = 1222,                  /* -msingle-float */
  OPT_msmartmips = 1223,                     /* -msmartmips */
  OPT_msoft_float = 1224,                    /* -msoft-float */
  OPT_msplit_addresses = 1225,               /* -msplit-addresses */
  OPT_msym32 = 1226,                         /* -msym32 */
  OPT_msynci = 1227,                         /* -msynci */
  OPT_mtune_ = 1228,                         /* -mtune= */
  OPT_muclibc = 1229,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1230,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1231,                          /* -mvirt */
  OPT_mvr4130_align = 1232,                  /* -mvr4130-align */
  OPT_mxgot = 1233,                          /* -mxgot */
  OPT_mxpa = 1234,                           /* -mxpa */
  OPT_n = 1235,                              /* -n */
  OPT_no_canonical_prefixes = 1236,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1237,              /* -no-integrated-cpp */
  OPT_noasmopt = 1238,                       /* -noasmopt */
  OPT_nocpp = 1239,                          /* -nocpp */
  OPT_nodefaultlibs = 1240,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1241,                   /* -nostartfiles */
  OPT_nostdinc = 1242,                       /* -nostdinc */
  OPT_nostdinc__ = 1243,                     /* -nostdinc++ */
  OPT_nostdlib = 1244,                       /* -nostdlib */
  OPT_o = 1245,                              /* -o */
  OPT_p = 1246,                              /* -p */
  OPT_pass_exit_codes = 1247,                /* -pass-exit-codes */
  /* OPT_pedantic = 1248, */                 /* -pedantic */
  OPT_pedantic_errors = 1249,                /* -pedantic-errors */
  OPT_pg = 1250,                             /* -pg */
  OPT_pie = 1251,                            /* -pie */
  OPT_pipe = 1252,                           /* -pipe */
  OPT_posix = 1253,                          /* -posix */
  OPT_print_file_name_ = 1254,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1255,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1256,          /* -print-multi-directory */
  OPT_print_multi_lib = 1257,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1258,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1259,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1260,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1261,               /* -print-prog-name= */
  OPT_print_search_dirs = 1262,              /* -print-search-dirs */
  OPT_print_sysroot = 1263,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1264,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1265,                        /* -profile */
  OPT_pthread = 1266,                        /* -pthread */
  OPT_quiet = 1267,                          /* -quiet */
  OPT_r = 1268,                              /* -r */
  OPT_rdynamic = 1269,                       /* -rdynamic */
  OPT_remap = 1270,                          /* -remap */
  OPT_s = 1271,                              /* -s */
  OPT_s_bc_abi = 1272,                       /* -s-bc-abi */
  ...
  OPT_static_libgcj = 1282,                  /* -static-libgcj */
  ...
  /* OPT_std_c1x = 1300, */                  /* -std=c1x */
  /* OPT_std_c89 = 1301, */                  /* -std=c89 */
  OPT_std_c90 = 1302,                        /* -std=c90 */
  OPT_std_c99 = 1303,                        /* -std=c99 */
  /* OPT_std_c9x = 1304, */                  /* -std=c9x */
  OPT_std_f2003 = 1305,                      /* -std=f2003 */
  OPT_std_f2008 = 1306,                      /* -std=f2008 */
  OPT_std_f2008ts = 1307,                    /* -std=f2008ts */
  OPT_std_f95 = 1308,                        /* -std=f95 */
  OPT_std_gnu = 1309,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1310, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1311, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1312,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1313,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1314, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1315, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1316,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1317,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1318,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1319, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1320, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1321,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1322,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1323, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1324, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1325,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1326, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1327, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1328, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1329,                     /* -std=legacy */
  OPT_symbolic = 1330,                       /* -symbolic */
  OPT_t = 1331,                              /* -t */
  OPT_time = 1332,                           /* -time */
  OPT_time_ = 1333,                          /* -time= */
  OPT_tno_android_cc = 1334,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1335,                 /* -tno-android-ld */
  OPT_traditional = 1336,                    /* -traditional */
  OPT_traditional_cpp = 1337,                /* -traditional-cpp */
  OPT_trigraphs = 1338,                      /* -trigraphs */
  OPT_u = 1339,                              /* -u */
  OPT_undef = 1340,                          /* -undef */
  OPT_v = 1341,                              /* -v */
  OPT_version = 1342,                        /* -version */
  OPT_w = 1343,                              /* -w */
  OPT_wrapper = 1344,                        /* -wrapper */
  OPT_x = 1345,                              /* -x */
  OPT_z = 1346,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
